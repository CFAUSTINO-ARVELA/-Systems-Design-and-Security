                ...
                if (type == "MSc" && placement == true)
                    ...
                    try {
                        ...
                        if (placement == true) {
                            ...
                            Degree deg2 = new Degree(nameInput.getText() + " with a Year in Industry", dep,
                        ...
                        if (count == 0)
                            JOptionPane.showMessageDialog(null,
                                    "There already is a degree with this name.  Please insert a different name.");
                        else {
                            JOptionPane.showMessageDialog(null, "Successfully created Degree: " + deg.getName());
                            this.degreeCreation.setVisible(false);
                            DegreeManagementScreen degMan = new DegreeManagementScreen(this.screen,
                                    degreeManagement.getTecMaangScree());
                            degMan.draw();
                        }
                    } catch (Exception ex) {
                        ex.printStackTrace();
