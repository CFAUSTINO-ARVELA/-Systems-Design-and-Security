...
class DegreeManagementScreen extends JPanel implements ActionListener {
                ...
                if (res == JOptionPane.OK_OPTION) {
                    try {
                        if (Account.delVerification(email.getText(), password.getText(), 3)) {
                            ...
                            this.degreeManagement.setVisible(false);
                            DegreeManagementScreen newDegMan = new DegreeManagementScreen(this.screen,
                                    this.teachingScreen);
                            newDegMan.draw();
                        } else
    ...
    private void initComponents() {
        ...
        degreeManagementTxt
                .setFont(degreeManagementTxt.getFont().deriveFont(degreeManagementTxt.getFont().getSize() + 10f));
